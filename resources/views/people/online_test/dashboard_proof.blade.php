        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                <div class="list-items flex flex-nowrap justify-between pr-10">
                    ...
                    @else
                        <a href="" class="w-full h-[41px] p-[10px_20px] bg-indigo-950 rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center" >Get Pro</a>
                    @endif
                    </div>
                </div>
