        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col px-5 mt-5">
                <div class="w-full flex justify-between items-center">
                    <div class="flex flex-col gap-1">
                        <p class="font-extrabold text-[30px] leading-[45px]">My Mental Health Test</p>
            ...
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                <div class="list-items flex flex-nowrap justify-between pr-10">
                    ...
                    @elseif($test->nextQuestionId !== null)
                        <a href="{{ route('dashboard.onlineTest.test', ['test' => $test->id, 'question' => $test->nextQuestionId]) }}" class="w-full h-[41px] p-[10px_20px] bg-[#6436F1] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center">Start Test</a>
                    @else
                        <a class="w-full h-[41px] p-[10px_20px] bg-gray-500 rounded-full font-bold text-sm text-white transition-all duration-300 text-center" >Done</a>
                    @endif
                    </div>
                </div>
                @empty
