...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <title>Manage Health Test - BeYourSelf</title>
            ...
            <div class="flex flex-col px-5 mt-5">
                <div class="w-full flex justify-between items-center">
                    <div class="flex flex-col gap-1">
                        <p class="font-extrabold text-[30px] leading-[45px]">Manage Health Test</p>
                        <p class="text-[#7F8190]">Please complete all sections of the mental health test to receive your full analysis</p>
                    </div>
                    <a href="{{route('dashboard.test.create')}}" class="h-[52px] p-[14px_20px] bg-[#5EC1F9] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D]">Add New Test</a>
                </div>
            </div>
                    ...
                    <div class="flex shrink-0 w-[300px]">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-[2px]">
                                ...
                                <p class="text-[#7F8190]">Mental Health Test</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex shrink-0 w-[120px] items-center">
                        <div class="relative h-[41px]">
                            <div class="menu-dropdown w-[120px] max-h-[41px] overflow-hidden absolute top-0 p-[10px_16px] bg-white flex flex-col gap-3 border border-[#EEEEEE] transition-all duration-300 hover:shadow-[0_10px_16px_0_#0A090B0D] rounded-[18px]">
                                ...
                                <a href="{{route('dashboard.test.show', $test->id) }}" class="flex items-center justify-between font-bold text-sm w-full">
                                    Manage
                                </a>
                                <a href="{{route('dashboard.test.edit', $test->id) }}" class="flex items-center justify-between font-bold text-sm w-full">
                                    Edit Test
                                </a>
