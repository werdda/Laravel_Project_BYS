...
<head>
  ...
  <link href="{{asset('css/output.css')}}" rel="stylesheet">
    <title>New Health Test - BeYourSelf</title>
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a class="text-[#7F8190] last:text-[#0A090B] last:font-semibold ">New Health Test</a>
                </div>
            </div>
            <div class="header flex flex-col gap-1 px-5 mt-5">
                <h1 class="font-extrabold text-[30px] leading-[45px]">New Health Test</h1>
            ...
            @endif
            <!-- product -->
            <form method="POST" enctype="multipart/form-data" action="{{route('dashboard.test.store')}}" class="flex flex-col gap-[30px] w-[500px] mx-[70px] mt-10">
                @csrf
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex gap-[10px] items-center">
                        <a href="#" class="group relative flex w-full items-center gap-[14px] p-[14px_16px] border border-[#EEEEEE] rounded-full transition-all duration-300 aria-checked:border-2 aria-checked:border-[#0A090B]" data-group="publish-date" aria-checked="true" onclick="handleActiveAnchor(this)" required>
                ...
                <div class="flex items-center gap-5">
                    ...
                    <button type="submit" class="w-full h-[52px] p-[14px_20px] bg-[#5EC1F9] rounded-full font-bold text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#5EC1F9] text-center">Save Test</button>
                </div>
            </form>
        </div>
    </section>
