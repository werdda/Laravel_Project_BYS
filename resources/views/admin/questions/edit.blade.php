...
<head>
  ...
  <link href="{{asset('css/output.css')}}" rel="stylesheet">
    <title>Edit Question Health Test - BeYourSelf</title>
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a class="text-[#7F8190] last:text-[#0A090B] last:font-semibold ">Edit Question Health Test</a>
                </div>
            </div>
            ...
            @if($errors->any())
                ...
                @endif
            <form method="POST" action="{{route('dashboard.test_questions.update', $testQuestion)}}" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                        ...
                        <input type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" value="{{$testQuestion->question}}" placeholder="Write the question" name="question">
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-4">
                            <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                                ...
                                <input required type="text" value="{{$answers[0]->answer }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write better answer option" name="answers[0]">
                            </div>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                                ...
                                <input required type="text" value="{{$answers[1]->answer }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write better answer option" name="answers[1]">
                            </div>
                            <label class="font-semibold flex items-center gap-[10px]">
                                <p>1</p>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                                ...
                                <input required type="text"  value="{{$answers[2]->answer }}"  class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write better answer option" name="answers[2]">
                            </div>
                            <label class="font-semibold flex items-center gap-[10px]">
                                <p>2</p>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                                ...
                                <input required type="text" value="{{$answers[3]->answer }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write better answer option" name="answers[3]">
                            </div>
                            <label class="font-semibold flex items-center gap-[10px]">
                                <p>3</p>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                                ...
                                <input required type="text" value="{{$answers[4]->answer }}" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write better answer option" name="answers[4]" >
                            </div>
                            <label class="font-semibold flex items-center gap-[10px]">
                                <p>4</p>
